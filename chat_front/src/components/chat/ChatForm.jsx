            ...
            if (chat.isFile != "Y") {
              ...
              const fileTag = (
                <a
                  ...
                  onClick={() => handleFileDownload(chat.fileId, chat.message)}
                >
                  {chat.message}
                </a>
              );
                    ...
                    <div>
                      <span
                        ...
                        style={{
                          fontSize: "13px",
                          paddingLeft:
                            msg.LR_className === "left" ? "11px" : "0",
                          paddingRight:
                            msg.LR_className === "right" ? "11px" : "0",
                        }}
                      >
                        {msg.senderName}
                      </span>
                    ...
                    <div>
                      <span
                        style={{
                          fontSize: "13px",
                          paddingLeft:
                            msg.LR_className === "left" ? "12px" : "0",
                          paddingRight:
                            msg.LR_className === "right" ? "12px" : "0",
                        }}
                      >
                        {msg.registerDate}
                      </span>
